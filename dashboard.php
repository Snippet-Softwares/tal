                ...
                <ul class="nav nav-tabs" id="myTab" role="tablist">
                    <li class="nav-item">
                        <a class="nav-link active" id="home-tab" data-toggle="tab" href="#home" role="tab"
                           aria-controls="home" aria-selected="true">Tank levels</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" id="profile_tab" data-toggle="tab" href="#profile" role="tab"
                           aria-controls="profile" aria-selected="false">Table View</a>
                    </li>
                </ul>
                                        ...
                                        <table class="table">
                                            <div class="wrap">
                                                <div class="row">
                                                    ...
                                                    <div class="col">
                                                        <div id=tank_three></div>
                                                    </div>
                                                    <div class="col">
                                                        <div id=tank_four></div>
                                                    </div>
                                                    <div class="col">
                                                        <div id=tank_five></div>
                                                    </div>
                                                    <div class="col">
                                                        <div id=tank_six></div>
                                                    </div>
                                                    <div class="col">
                                                        <div id=tank_seven></div>
                                                    </div>
                                                </div>
                                            </div>
                                        </table>
